...
var creatorList = ['@dilstore','@xorzbot'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'dzsteamofc') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'dzsteamofc') return res.json(loghandler.invalidKey)
